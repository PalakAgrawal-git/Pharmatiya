 ...
 * A deliberate pause.
 *
 * One serif statement across seven columns with a great deal of nothing
 * around it, and a short supporting paragraph set narrow beneath. It carries
 * no chart, no link and no action.
 *
  ...
  return (
    <section className="border-b border-rule">
      <div className="shell section grid gap-x-16 gap-y-10 lg:grid-cols-12">
        ...
        <Reveal delay={140} className="lg:col-span-4 lg:col-start-3">
